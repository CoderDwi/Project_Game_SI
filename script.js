...
//retourner les objets a ses place apres le but 
function refresh(){
...
function start(){
	...
	gererGardien();
//  rect();
	verfierClavierKeyCode();
	verfierCBornesJoueurs();
	verifierBornesBall();
	verifierImpactEntreJoueur();
	deplaceJoueur();
	deplaceBall();
	gereeJoueur();
	gereeBall();
	out.innerHTML = "Ronaldo : " + ronaldo.score + " |-| "+messi.score+" : Messi  ";
